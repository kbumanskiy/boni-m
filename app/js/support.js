...
//
// ⚠ ПОМЕНЯЛИ АДРЕС — ПОДНИМИТЕ CACHE в app/sw.js. Офлайн-кэш отдаёт файлы
// из себя, не переспрашивая сервер. Если версия кэша та же, браузер не заметит
// обновления и будет вечно отдавать старый файл: кнопка не появится ни у кого,
// и понять почему будет невозможно — на сервере-то всё правильно.
