...
// ВНИМАНИЕ: коды взяты из ТЗ дословно. Три из них (Точка, Запятая, Восклицание)
// расходятся с международным стандартом ITU — см. флаг ниже. Ждёт решения Кости.
export const PUNCTUATION = [
  { char: '.', name: 'Точка',        code: '......' },   // ITU: .-.-.-  (расхождение!)
  { char: ',', name: 'Запятая',      code: '.-.-.-' },   // ITU: --..--  (расхождение!)
  { char: ':', name: 'Двоеточие',    code: '---...' },
  { char: '?', name: 'Вопрос',       code: '..--..' },
  { char: '!', name: 'Восклицание',  code: '--..--' },   // ITU: -.-.--  (расхождение!)
