...
export const ICON = {
  ...
  // Настройки: шестерёнка. Рисуем восемью зубцами по кругу — узнаваемо в любом размере
  // и не превращается в кляксу на маленьком экране.
  gear: (s) => svg('<circle cx="12" cy="12" r="3.2"/><path d="M12 2.8v2.6M12 18.6v2.6M21.2 12h-2.6M5.4 12H2.8M18.5 5.5l-1.8 1.8M7.3 16.7l-1.8 1.8M18.5 18.5l-1.8-1.8M7.3 7.3 5.5 5.5"/>', s),
  // Подсказка
