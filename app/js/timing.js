...
export const LIMITS = {
  ...
  effWpm:  { min: 5, max: 45 },   // сверху всё равно зажимается скоростью знака (E <= C)
  keyWpm:  { min: 5, max: 25 },
  toneHz:  { min: 400, max: 1000 },
  volume:  { min: 0.15, max: 1 },  // ниже 0,15 морзянку уже не слышно — глушить нечем, есть кнопка выхода
};
